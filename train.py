...
train_dataset = ImageDataset(data_dir, True, device, use_patches=False, resize_to=(224, 224))
val_dataset = ImageDataset(data_dir, False, device, use_patches=False, resize_to=(224, 224))
